/**********************r/bin/env /bin/sh /tmp/Microsoft-MIEngine-Cmd-w2oqwrca.3zd 
 l*******************************
 *
 ...
 * @return bounding box
 */
static Eigen::AlignedBox<scalar, 3>
computeBoundingBox(const Eigen::Matrix<scalar, 3, Eigen::Dynamic> &vertices) {
...
static bool
checkCell(const std::unordered_map<CellPos, HashEntry, HashFunc> &hMap,
          const CellPos &cell, const PossiblePoint &point,
...
static bool
checkNeighbors(const std::unordered_map<CellPos, HashEntry, HashFunc> &hMap,
