...
RigidBodyGeometry::~RigidBodyGeometry(void) { m_mesh.release(); }
...
void RigidBodyGeometry::initMesh(const unsigned int nVertices,
                                 ...
                                 const Mesh::UVs &uvs, const Vector3r &scale,
...
void RigidBodyGeometry::updateMeshTransformation(const Vector3r &x,
                                                 const Matrix3r &R) {
