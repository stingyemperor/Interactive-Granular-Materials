...
public:
   ...
   * \return		returns true when the other is contained in this sphere or
   * vice versa
   */
...
private:
  /**
   * \brief		constructs the smallest enclosing sphere for n points with the
   * points q1, q2, and q3 on the surface of the sphere
   *
   ...
   */
  BoundingSphere ses3(int n, std::vector<Eigen::Vector3d> &p,
                      Eigen::Vector3d &q1, Eigen::Vector3d &q2,
                      Eigen::Vector3d &q3) {
  ...
  /**
   * \brief		constructs the smallest enclosing sphere for n points with the
   * points q1 and q2 on the surface of the sphere
   *
   * \param n		number of points
   * \param p		vertices of the points
   * \param q1	3d coordinates of a point on the surface
   ...
   * \return		smallest enclosing sphere
   */
  BoundingSphere ses2(int n, std::vector<Eigen::Vector3d> &p,
                      Eigen::Vector3d &q1, Eigen::Vector3d &q2) {
  ...
  /**
   * \brief		constructs the smallest enclosing sphere for n points with the
   * point q1 on the surface of the sphere
   *
   * \param n		number of points
   * \param p		vertices of the points
   * \param q1	3d coordinates of a point on the surface
   * \return		smallest enclosing sphere
   */
  BoundingSphere ses1(int n, std::vector<Eigen::Vector3d> &p,
                      Eigen::Vector3d &q1) {
